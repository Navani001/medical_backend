...
router.post("/delete", controllers.deletedrx_drug);
router.post("/add_drug_rx/:id", controllers.add_drug_rx);
router.post("/changetakentime", controllers.changetakentime);
router.post("/add_rxtorx", controllers.add_rxtorx);

router.post("/change_comsumption_type", controllers.change_comsumption_type);
router.post(
  "/change_comsumption_day_type",
  controllers.change_comsumption_day_type
);
router.post("/allSpecs", controllers.allSpecs);
